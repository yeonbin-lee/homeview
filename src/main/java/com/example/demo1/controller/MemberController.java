...
//            log.info("get값은" + email);
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestBody UserRequestDto userRequestDto, HttpSession session /*BindingResult bindingResult*/) throws Exception{
